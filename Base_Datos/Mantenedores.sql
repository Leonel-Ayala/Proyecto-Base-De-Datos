...
CREATE OR REPLACE PROCEDURE LAROATLB_GESTIONA_LOG_LOGIN(
    P_NOMBRE_INGRESO VARCHAR2)
IS
BEGIN
    LOCK TABLE LAROATLB_DETALLE_LOG_LOGIN IN ROW EXCLUSIVE MODE;
    INSERT INTO LAROATLB_LOG_LOGIN(NOMBRE_INGRESO,FECHA_INGRESO)
    VALUES(P_NOMBRE_INGRESO,SYSDATE);
COMMIT;
