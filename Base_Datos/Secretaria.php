...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center flex-grow-1">
        <h2 class="mb-4 text-center">Bienvenido a la página de Secretaría, <?php echo htmlspecialchars($_SESSION['username']); ?>!</h2>
        <p class="text-center">Solo usuarios autorizados pueden ver este contenido.</p>

        <!-- Botones para acciones -->
        <a href="registrar_cita.php" class="btn btn-success btn-lg mt-3">Registrar Cita</a>
