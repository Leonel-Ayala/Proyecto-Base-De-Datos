...
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center">Gestión de Regiones</h1>
            </div>
            <div class="col-12">
                <?php if ($error): ?>
    ...
    <script>
        ...
        function showForm(action, regionData = {}) {
            ...
            if (action === 'insertar') {
                ...
                `;
                document.getElementById('exampleModalLabel').innerHTML = 'Insertar Regiones';
                ...
                document.getElementById('exampleModalLabel').innerHTML = 'Actualizar Región';
            }
                ...
                document.getElementById('exampleModalLabel').innerHTML = 'Eliminar Región';
            }
